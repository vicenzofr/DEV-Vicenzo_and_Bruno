      ...
      <div class="form">
         ...
         <form method="POST" action="../php/processo_cliente.php" enctype="multipart/form-data">
            ...
            <div class="btn">
               ...
               <button type="button" class="button2" href="criar_conta.html">Increva-se</button>
            </div>
            <button type="button"  class="button3" href="esqueceu_senha.html">
            Esqueceu a Senha</button>
            <button type="button"  class="button4" href="catalogo.html">Entrar como visitante</button>
         </form>
      </div>
